...
import { Alert, Image, View, Text, FlatList, StyleSheet,Pressable, TouchableOpacity, ScrollView } from 'react-native';
...
import { AppContext } from '../../AppContext';
  ...
  const cakepoint = React.memo(({ navigation }) => {
    ...
    const renderDataItem = (item) => (
      <View key={item.id} style={styles.grayBox2}>
        ...
        <TouchableOpacity onPress={() => handleAddToFavourite(item)} style={styles.favoriteButton}>
          <Ionicons
